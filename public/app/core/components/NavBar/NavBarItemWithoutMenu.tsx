...
export function NavBarItemWithoutMenu({
  ...
  const styles = getNavBarItemWithoutMenuStyles(theme, isActive, isBottom);
...
export function getNavBarItemWithoutMenuStyles(theme: GrafanaTheme2, isActive?: boolean, isBottom?: boolean) {
  return {
    container: css({
      position: 'relative',
    ...
    element: css({
      ...
      '&::before': {
        ...
        bottom: isBottom ? 0 : theme.spacing(1.5),
